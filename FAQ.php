...
<!--                        <li class="dropdown">
       ...
       <div class="container">
        ...
        <button class="accordion">How do I sign up for membership</button>
        <div class="panel">
            <p>Go to the members page by clicking on it in the top navigation bar.</p>
        </div>

        <button class="accordion">How do I change my password</button>
        <div class="panel">
            <p>Unfortunately, you are unable to change your account password. Please contact our team for support.</p>
        </div>

        <button class="accordion">Can I delete my account?</button>
        <div class="panel">
            <p>Unfortunately, you are unable to delete your account once it is created. Please contact our team for support.</p>
        </div>
        
        <button class="accordion">Can I cancel my membership?</button>
        <div class="panel">
            <p>Yes you can. Please contact our team for support.</p>
        </div>
        
        
        <h2>Events</h2>

        <button class="accordion">How do I host an event</button>
        <div class="panel">
            <p>Go to the host an event page by clicking on the activities in the top navigation bar.</p>
        </div>

        <button class="accordion">Can I delete my event</button>
        <div class="panel">
            <p>Unfortunately, and event cannot be deleted once it has been created.</p>
        </div>

        <button class="accordion">Will I be penalized for missing an event?</button>
        <div class="panel">
            <p>If the hosts of the event reports you for more than 3 times, our team will take action.</p>
        </div>
