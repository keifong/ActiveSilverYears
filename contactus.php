...
//                    document.formu.reset();
            ...
            <div class="container">
                <h1 style="font-family: Montserrat, sans-serif;">Contact Us</h1>
                <br>
                <p>
                <form action="insertcontact.php" method="post" id="myform">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="location" name="contactemail">
                    </div>

                    <div class="form-group">
                        <label for="time">Contact Number:</label>
                        <input type="text" class="form-control" id="time" name="contactnumber">
                    </div>


                    <div class="form-group">
                        <label for="description">Your Comment:</label>
                        <textarea class="form-control" id="description" rows="5" name="comment"> </textarea>
                    </div> 
