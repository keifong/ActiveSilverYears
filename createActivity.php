...
//                    document.formu.reset();
            ...
            <div class="container">
                <h2 style="font-family: Montserrat, sans-serif;">Host Your Own Event!</h2>
                <p style="font-family: Montserrat, sans-serif;">Create an event for others to join!</p>
                <br>
                <form action="insert.php" method="post" id="myform">
                    ...
                    <div class="form-group">
                        ...
                        <label for="time" style="margin-left: 20px">Time of Event:</label>
                        <input type="time" id="time" name="eventtime">
                    </div>

                    <div class="form-group">
                        <label for="title">Title:</label>
                        <input type="text" class="form-control" id="title" name="eventtitle">
                    </div>

                    <div class="form-group">
                        <label for="location">Location:</label>
                        <input type="text" class="form-control" id="location" name="eventlocation">
                    </div>

                    <div class="form-group">
                        <label for="description">What will the event be about:</label>
                        <textarea class="form-control" id="description" rows="5" name="eventdesc"> </textarea>
                    </div> 

                    <div>
<!--                        <input type="submit" value="Host Event">-->
                        <input type="button" value="Host Event" onclick="submit_form();" />
                    </div>
